import"./modulepreload-polyfill-B5Qt9EMX.js";const o=new Lenis;o.on("scroll",ScrollTrigger.update);gsap.ticker.add(e=>{o.raf(e*1e3)});gsap.ticker.lagSmoothing(0);gsap.to(window,{scrollTo:0});const t=document.querySelector("#cursor");window.addEventListener("mousemove",function(e){t&&gsap.to(t,{opacity:1,top:e.clientY,left:e.clientX})});function l(){const e=document.querySelector("#point"),s=document.querySelector("#f");var a=gsap.timeline({scrollTrigger:{trigger:"#page1",scroller:"body",start:"top top",end:"top -5%",scrub:1}});a.to("#point",{opacity:0,x:2,duration:.2,ease:"power1.out"},"a").to("#f",{opacity:0,x:2,duration:.2,ease:"power1.out"},"a").to("#p",{x:e.offsetWidth/2+e.offsetWidth/2/2.7,duration:.4,delay:.2},"a").to("#dot",{opacity:1,x:-s.offsetWidth*3,duration:.4,delay:.2},"a").to("#o",{x:-s.offsetWidth*2,duration:.4,delay:.2},"a")}l();function r(){var e=localStorage.getItem("mode")==="true";const s=document.documentElement;e?(s.style.setProperty("--primary","#000"),s.style.setProperty("--secondary","#fff"),document.querySelector("#mode").classList.remove("ri-sun-line"),document.querySelector("#mode").classList.add("ri-moon-line"),document.querySelector("#navbar").style.background=`
  linear-gradient(
    180deg,
    #000000 0,
    hsla(0, 0%, 0%, .987) 11%,  
...
`),document.querySelector("#mode").addEventListener("click",function(){e?(s.style.setProperty("--primary","#F2F2EE"),s.style.setProperty("--secondary","#000"),document.querySelector("#mode").classList.remove("ri-moon-line"),document.querySelector("#mode").classList.add("ri-sun-line"),document.querySelector("#navbar").style.background=`
  linear-gradient(
    180deg,
    #F2F2EE 0,
    hsla(0, 0%, 94.1%, .987) 11%,  
...
//# sourceMappingURL=index-DmbJihz9.js.map
