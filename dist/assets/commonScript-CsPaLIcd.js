...
`,t=!0),localStorage.setItem("mode",t)})}c();function d(){var t=!1;document.querySelector("#menu-c").addEventListener("click",function(){t?(gsap.to("#navigation",{top:"-130%",clipPath:"polygon(0 0, 100% 0, 100% 97%, 0 89%)",duration:1.5,ease:"power4.out"}),t=!1):(gsap.to("#navigation",{top:0,clipPath:"polygon(0 0, 100% 0, 100% 100%, 0 100%)",duration:1.5,ease:"power4.out"}),t=!0)});let e=document.querySelectorAll(".shape"),r=document.querySelectorAll("#shape-select a"),s=document.querySelectorAll("#social-l a");r.forEach(function(o){o.addEventListener("mouseenter",function(){for(var a=0;a<=r.length;a++)r[a]!==o?gsap.to(r[a],{filter:"blur(4px)",opacity:.4,duration:.4}):gsap.to(o,{filter:"blur(0px)",opacity:1,duration:.4});o.getAttribute("data-index")!=="0"&&(gsap.to(e[0],{transform:"rotate(40deg) scale(0)",opacity:0,duration:.5,ease:"power4.out"}),gsap.to(e[o.getAttribute("data-index")],{transform:"rotate(0deg) scale(1)",opacity:1,duration:.5,ease:"power4.out"}))})}),r.forEach(function(o,a){o.addEventListener("mouseleave",function(){gsap.to(r,{filter:"blur(0px)",opacity:1,duration:.4}),o.getAttribute("data-index")!=="0"&&(gsap.to(e[o.getAttribute("data-index")],{transform:"rotate(40deg) scale(0)",opacity:0,duration:.5,ease:"power4.out"}),gsap.to(e[0],{transform:"rotate(0deg) scale(1)",opacity:1,duration:.5,ease:"power4.out"}))})}),s.forEach(function(o){o.addEventListener("mouseenter",function(){for(var a=0;a<=s.length;a++)s[a]!==o?gsap.to(s[a],{filter:"blur(2px)",opacity:.5,duration:.4}):gsap.to(o,{filter:"blur(0px)",opacity:1,duration:.4})})}),s.forEach(function(o,a){o.addEventListener("mouseleave",function(){gsap.to(s,{filter:"blur(0px)",opacity:1,duration:.4})})})}d();
//# sourceMappingURL=commonScript-CsPaLIcd.js.map
