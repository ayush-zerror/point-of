...
export default function Footer() {
  return (
    <footer className="w-full bg-black">
      <div className="px-4 sm:px-10 md:px-16 lg:px-20 mx-auto py-12 md:py-16 lg:pt-24 lg:pb-16">
        ...
        {/* DIVIDER */}
        <div className="border-t border-neutral-700 mt-10 md:mt-12 pt-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm">
