...
const JoinTeam = () => {
  ...
  return (
    <section className="w-full pt-16 sm:pt-20 md:pt-28 lg:pt-32">
      <div className="w-full px-6 sm:px-10 md:pl-12 xl:pl-48 2xl:pl-[30rem] pr-6">
        {/* Heading */}
        ...
        {/* Description */}
        <p className="max-w-none xl:max-w-3xl para text-desc">
          ...
          <a
            href="mailto:people@wearepointof.com"
            className="text-heading"
            title="Email careers at Point Of"
          >
            {" "}
            people@wearepointof.com
          </a>
        </p>
