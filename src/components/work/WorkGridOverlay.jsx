...
export default function WorkGridOverlay({
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex items-center justify-between fixed bottom-0 left-0 z-30 px-6 sm:px-10 md:px-12 lg:px-16 xl:px-20 pb-6 sm:pb-10 md:pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 lg:gap-0 lg:grid-cols-3 px-6 sm:px-10 md:px-12 lg:px-16 xl:px-20 pt-20 sm:pt-24 lg:pt-28  xl:pt-0 pb-24 sm:pb-28 lg:pb-28 xl:pb-0">
